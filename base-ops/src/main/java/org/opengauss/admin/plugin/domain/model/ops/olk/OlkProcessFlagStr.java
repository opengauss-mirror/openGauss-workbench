...
public class OlkProcessFlagStr {
    public static final String START_PROCESS = "Start OpenLooKeng Deploy Process, This may take 5~10 minutes...";
    ...
    public static final String END_UPLOAD = "Uploading Packages Complete";
    public static final String RUN_DAD_SERVICE  = "Running Deployment Service";
    public static final String RUN_DAD_SERVICE_COMPLETE  = "Running Deployment Service Complete";
    ...
    public static final String END_INSTALL_OLK = "Start Install OpenLooKeng On %s";
    public static final String END_INSTALL = "Install All Packages Complete";
    public static final String START_SERVICE = "Start All Service";
