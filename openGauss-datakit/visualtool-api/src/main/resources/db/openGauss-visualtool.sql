...
UPDATE "public"."sys_setting" SET portal_pkg_name = ''PortalControl-6.0.0rc1.tar.gz'';
UPDATE "public"."sys_setting" SET portal_jar_name = ''portalControl-6.0.0rc1-exec.jar'';
END IF;
RETURN 0;
END;'
LANGUAGE plpgsql;
...
-- ----------------------------
INSERT INTO "public"."sys_setting" VALUES (1, 1, '/ops/files/', 'https://opengauss.obs.cn-south-1.myhuaweicloud.com/latest/tools/', 'PortalControl-6.0.0rc1.tar.gz', 'portalControl-6.0.0rc1-exec.jar') ON DUPLICATE KEY UPDATE NOTHING;
