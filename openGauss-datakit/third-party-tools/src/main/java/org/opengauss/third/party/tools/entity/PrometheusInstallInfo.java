...
/**
 * Prometheus install info class
 *
 * @since 2026/6/8
 */
@Data
public class PrometheusInstallInfo extends BaseInstallInfo {
    /**
    ...
    public String getCsvData() {
        if (serverPort == null) {
            throw new IllegalArgumentException("Prometheus install info serverPort must not be null");
        }
