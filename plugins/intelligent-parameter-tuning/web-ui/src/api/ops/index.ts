...
export const getAllCluster = () => {
  return axios.get('intelligent/tuning/obtain/cluster')
}

export const getAlldbList = (data: string) => {
  return axios.get('intelligent/tuning/obtain/database', {
    params: data
  })
}
...
export const trainingModel = (data: FormData) => {
  return axios.post('intelligent/tuning/start', data)
}

export const getParamList = (data: KeyValue) => {
  return axios.post(`intelligent/tuning/obtain/parameter/recommendation/${data.pageNum}/${data.pageSize}`, data)
}

export const paramDetails = (data: string) => {
  return axios.get('intelligent/tuning/obtain/parameter/view', {
    params: data
  })
}

export const isApplicationParams = (data: KeyValue) => {
  return axios.post('intelligent/tuning/apply/reduction', data)
}

export const getLogList = (data: KeyValue) => {
  return axios.post(`intelligent/tuning/obtain/operation/log/${data.pageNum}/${data.pageSize}`, data)
}

export const procssDetails = (data: string) => {
  return axios.get('intelligent/tuning/obtain/parameter/list', {
    params: data
  })
}

export const stopTaskList = (data: KeyValue) => {
  return axios.post('/intelligent/tuning/stop', data)
}

export const deleteTaskList = (data: KeyValue) => {
  return axios.post('intelligent/tuning/delete', data)
}

export const deleteParamList = (data: KeyValue) => {
  return axios.post('intelligent/tuning/delete/suggest', data)
}

export const deleteLogList = (data: KeyValue) => {
  return axios.post('intelligent/tuning/delete/log', data)
}

export const getTaskClusterName = () => {
  return axios.get('intelligent/tuning/obtain/task/clusterName')
}

export const getTaskDatabase = () => {
  return axios.get('intelligent/tuning/obtain/task/database')
}

export const taskLogPreview = (data: KeyValue) => {
  return axios.post('intelligent/tuning/view/task/log', data)
}

export const getParamClusterName = () => {
  return axios.get('intelligent/tuning/obtain/parameter/recommendation/clusterName')
}

export const getParamDatabase = () => {
  return axios.get('intelligent/tuning/obtain/parameter/recommendation/database')
}

export const getLogClusterName = () => {
  return axios.get('intelligent/tuning/obtain/operation/log/clusterName')
}

export const downloadTemplate = (data: string) => {
  return axios.get('intelligent/tuning/download', {
    params: data
  })
}

export const previewTemplate = (data: string) => {
  return axios.get('intelligent/tuning/preview', {
    params: data
  })
}
// =====================
