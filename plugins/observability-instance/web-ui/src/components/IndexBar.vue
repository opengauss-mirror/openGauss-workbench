<template>
    <div class="refresh-bar-container">
        <div class="refresh-bar-filter" >
            ...
            <el-select v-model="autoRefreshTime" style="width: 80px; margin: 0 4px">
...
const { sourceType, autoRefreshTime, timeType, timeTypeSelection, timeRange } = storeToRefs(
...
// watch(timeType, () => {
//     if (timeType.value === timeTypeSelection.value.CUSTOM) {
//         const end = new Date()
