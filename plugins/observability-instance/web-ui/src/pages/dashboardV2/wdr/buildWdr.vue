<template>
    <div class="dialog">
        <el-dialog
            width="400px"
            :title="$t('dashboard.wdrReports.buildWDR')"
            v-model="visible"
                    ...
                    <el-form-item :label="$t('dashboard.wdrReports.buildWDRDialog.startSnapshot')" prop="startId">
                        <el-select v-model="formData.startId" style="width: 200px; margin: 0 4px">
                            <el-option
                                ...
                                :key="item.snapshotId"
                                :label="item.snapshotId"
                                :value="item.snapshotId"
                                :disabled="parseInt(item.snapshotId) >= parseInt(formData.endId)"
                            />
                        </el-select>
                    </el-form-item>
                    <el-form-item :label="$t('dashboard.wdrReports.buildWDRDialog.endSnapshot')" prop="endId">
                        <el-select v-model="formData.endId" style="width: 200px; margin: 0 4px">
                            <el-option
                                ...
                                :label="item.snapshotId"
                                :value="item.snapshotId"
                                :disabled="parseInt(item.snapshotId) <= parseInt(formData.startId)"
                            />
                        </el-select>
                    </el-form-item>
                </el-form>
