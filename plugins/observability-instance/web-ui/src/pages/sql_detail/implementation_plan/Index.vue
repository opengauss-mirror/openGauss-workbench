    ...
    <div class="implementation-plan" v-if="!errorInfo">
        <div class="i-p-filter">
            <el-tooltip
                ...
                style="color: #fff"
            >
                <template #content><p :style="{color: theme === 'dark' ? '#D4D4D4' : '#868F9C'}">{{ $t('sql.mostWidthPosi') }}</p></template>
            ...
            <el-tooltip
                ...
                placement="bottom"
            >
                <template #content><p :style="{color: theme === 'dark' ? '#D4D4D4' : '#868F9C'}">{{ $t('sql.mostRowsPosi') }}</p></template>
            ...
            >
                <template #content><p :style="{color: theme === 'dark' ? '#D4D4D4' : '#868F9C'}">{{ $t('sql.mostCostPosi') }}</p></template>
