...
public class CommonConstants {
	...
	public static final String INSERT_INTO_PARAM_INFO_SQL = "insert into param_info(paramType,paramName,paramDetail,suggestValue,defaultValue,unit,suggestExplain,diagnosisRule)\n";
