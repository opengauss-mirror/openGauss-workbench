 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-instance/src/main/java/com/nctigba/observability/instance/aspectj/DatasourceAspect.java
 *
 *  -------------------------------------------------------------------------
 */

package com.nctigba.observability.instance.aspectj;
...
public class DatasourceAspect {
     ...
     */
    @Around("@annotation(com.nctigba.observability.instance.aspectj.annotation.Ds)")
