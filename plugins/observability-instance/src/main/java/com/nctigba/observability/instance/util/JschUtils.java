 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-instance/src/main/java/com/nctigba/observability/instance/util/JschUtils.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class JschUtils {
    ...
    public JschResult executeCommand(
        ...
        if (Objects.nonNull(autoResponse)) {
            HashMap<String, String> autoClone = new HashMap<>(JschUtils.autoResponseContext);
            autoClone.putAll(autoResponse);
            autoResponse = autoClone;
        } else {
            autoResponse = JschUtils.autoResponseContext;
        }
