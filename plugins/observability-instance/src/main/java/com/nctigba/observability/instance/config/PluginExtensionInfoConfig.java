 ...
 *  src/main/java/com/nctigba/observability/instance/config/PluginExtensionInfoConfig.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class PluginExtensionInfoConfig implements PluginExtensionInfo {
    ...
    public Map<String, Object> extensionInfo() {
        ...
        map.put("configAttrs", "[{\"attrCode\":\"esHost\",\"attrLabel\":\"ES服务器\"},{\"attrCode\":\"esPort\","
                + "\"attrLabel\":\"端口\"}]");
        map.put("descriptionEn", "Instance Monitoring Plugin");
        return map;
    }
}