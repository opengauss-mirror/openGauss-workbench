...
package com.nctigba.observability.log.enums;
...
public enum DbDataLocationEnum {
    INTARKDB("org.intarkdb.Driver", Arrays.asList("classpath:IntarkDB-schema-all.sql")),
    OPENGAUSS("org.opengauss.Driver", Arrays.asList("classpath:openGauss-schema-all.sql"));
