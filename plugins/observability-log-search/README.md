...
| 日期       | 版本   | 变更说明     | 修改人   | 审批人 |
| ---------- | ------ | ------------ | -------- | ------ |
| 2022/12/19 | v1.0.0 | 新增编译初版 | wuyuebin | 曾色亮 |
...
3、将鼠标移到列表中的日志，将在该日志右边显示【上下文】按钮图标，点击该图标，将打开新页面，查询日志上下文。
...
![image-20230313205531477](doc/log_search_limit.png)

注：如果日志内容和日志时间不为空，则检索日志；如果上下文条件不为空，其他都为空，则查询日志上下文
