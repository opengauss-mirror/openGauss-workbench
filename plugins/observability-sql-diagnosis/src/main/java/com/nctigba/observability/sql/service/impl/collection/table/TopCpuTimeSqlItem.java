 ...
 *  -------------------------------------------------------------------------
 *
 *  TopCpuTimeSqlItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/table/TopCpuTimeSqlItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TopCpuTimeSqlItem extends DatabaseCollectionItem {
    ...
    public String getDatabaseSql() {
        return SqlConstants.TOP_CPU_TIME_SQL;
    }
}
