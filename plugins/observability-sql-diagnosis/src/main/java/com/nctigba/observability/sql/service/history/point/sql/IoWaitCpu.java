 ...
 */
@Service
public class IoWaitCpu implements HisDiagnosisPointService<Object> {
    @Autowired
    ...
    public AnalysisDTO analysis(HisDiagnosisTask task, DataStoreService dataStoreService) {
        ...
        if (file != null) {
            TaskResult waitResult = new TaskResult(task,
                    TaskResult.ResultState.NO_ADVICE, ResultType.iowait, FrameType.LineChart,
