 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/ebpf/OsParamItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class OsParamItem extends EbpfCollectionItem {
    ...
    public String getHttpParam() {
        return AgentParamConstants.OS_PARAM;
    }
}