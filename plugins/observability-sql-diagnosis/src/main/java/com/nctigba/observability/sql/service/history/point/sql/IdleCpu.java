 ...
 */
@Service
public class IdleCpu implements HisDiagnosisPointService<Object> {
    ...
    private List<TaskResult> getResultData(HisDiagnosisTask task, MultipartFile file) {
        try {
            ...
            all.parse();
            idle.parse();
            TaskResult idleResult = new TaskResult(task, TaskResult.ResultState.NO_ADVICE, ResultType.idle,
                    FrameType.LineChart,
