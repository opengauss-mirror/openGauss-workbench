 ...
 *  -------------------------------------------------------------------------
 *
 *  ThreadWaitEventItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/table/ThreadWaitEventItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class ThreadWaitEventItem extends DatabaseCollectionItem {
    ...
    public String getDatabaseSql() {
        return SqlConstants.WAIT_EVENT;
    }
}
