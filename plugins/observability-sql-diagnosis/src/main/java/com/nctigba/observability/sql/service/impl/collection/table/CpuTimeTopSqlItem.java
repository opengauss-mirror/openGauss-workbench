 ...
 *  -------------------------------------------------------------------------
 *
 *  CpuTimeTopSqlItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/table/CpuTimeTopSqlItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class CpuTimeTopSqlItem extends DatabaseCollectionItem {
    ...
    public String getDatabaseSql() {
        return SqlConstants.CPU_TIME_TOP_SQL;
    }
}
