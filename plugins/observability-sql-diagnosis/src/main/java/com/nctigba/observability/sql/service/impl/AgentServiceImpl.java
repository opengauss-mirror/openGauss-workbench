...
@Service
public class AgentServiceImpl extends AbstractInstaller {
    ...
    public void uninstall(WsSession wsSession, String nodeId, String rootPassword) {
        ...
        try {
            ...
            env.setHost(hostEntity);
            try (var sshsession = SshSessionUtils.connect(hostEntity.getPublicIp(), hostEntity.getPort(), "root",
