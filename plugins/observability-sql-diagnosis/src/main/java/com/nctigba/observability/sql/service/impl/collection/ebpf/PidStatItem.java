 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/ebpf/PidStatItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class PidStatItem extends EbpfCollectionItem {
    ...
    public String getHttpParam() {
        return AgentParamConstants.PID_STAT;
    }
}