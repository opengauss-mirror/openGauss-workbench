 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/ebpf/TcpLifeItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TcpLifeItem extends EbpfCollectionItem {
    ...
    public String getHttpParam() {
        return AgentParamConstants.TCP_LIFE;
    }
}