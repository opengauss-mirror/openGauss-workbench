 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/ebpf/FileTopItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class FileTopItem extends EbpfCollectionItem {
    ...
    public String getHttpParam() {
        return AgentParamConstants.FILE_TOP;
    }
}