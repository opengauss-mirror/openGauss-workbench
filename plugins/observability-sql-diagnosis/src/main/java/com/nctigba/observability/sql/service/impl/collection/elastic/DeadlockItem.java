 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/elastic/DeadlockItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class DeadlockItem extends ElasticSearchCollectionItem {
    ...
    public String getQueryParam() {
        return ElasticSearchConstants.DEADLOCK;
    }
}