 ...
 *  -------------------------------------------------------------------------
 *
 *  LogDetailInfoVO.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/model/vo/point/LogDetailInfoVO.java
 *
 *  -------------------------------------------------------------------------
 */
