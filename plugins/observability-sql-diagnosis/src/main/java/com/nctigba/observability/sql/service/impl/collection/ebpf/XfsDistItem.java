 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/main/java/com/nctigba/observability/sql/service/impl/collection/ebpf/XfsDistItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class XfsDistItem extends EbpfCollectionItem {
    ...
    public String getHttpParam() {
        return AgentParamConstants.XFS_DIST;
    }
}