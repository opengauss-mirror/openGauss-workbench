 ...
 *  -------------------------------------------------------------------------
 *
 *  TestThreadWaitEventItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/collection/TestThreadWaitEventItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestThreadWaitEventItem {
    ...
    public void testGetDatabaseSql() {
        ...
        assertEquals(sql, SqlConstants.WAIT_EVENT);
    }
}
