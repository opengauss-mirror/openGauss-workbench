 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestTcpTop.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.TcpTop;
...
public class TestTcpTop {
    @Mock
    private TcpTopItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private TcpTop pointService;
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.TCPTOP;
