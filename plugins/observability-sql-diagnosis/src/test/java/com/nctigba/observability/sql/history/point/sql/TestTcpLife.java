 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestTcpLife.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.TcpLife;
...
public class TestTcpLife {
    @Mock
    private TcpLifeItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private TcpLife pointService;
