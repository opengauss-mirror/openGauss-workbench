 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestXfsSlower.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.XfsSlower;
...
public class TestXfsSlower {
    @Mock
    private XfsSlowerItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private XfsSlower pointService;
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.BIOSNOOP;
