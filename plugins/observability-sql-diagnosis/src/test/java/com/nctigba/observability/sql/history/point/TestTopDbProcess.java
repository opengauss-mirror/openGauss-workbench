 ...
 *  -------------------------------------------------------------------------
 *
 *  TestTopDbProcess.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/TestTopDbProcess.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.history.TopDbProcess;
...
public class TestTopDbProcess {
    ...
    @InjectMocks
    private TopDbProcess topDbProcess;
    ...
    public void testGetOption() {
        List<String> list = topDbProcess.getOption();
        assertNull(list);
    }
    ...
    public void testGetSourceDataKeys() {
        List<CollectionItem<?>> result = topDbProcess.getSourceDataKeys();
    ...
    public void testAnalysis_NoAgentData() {
        ...
        AnalysisDTO result = topDbProcess.analysis(diagnosisTaskDO, dataStoreService);
    ...
    public void testGetShowData() {
        AgentDTO agentDTO = topDbProcess.getShowData(1);
        assertNull(agentDTO);
    }
}
