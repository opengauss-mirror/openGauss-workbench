 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/collection/TestOffCpuItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestOffCpuItem {
    ...
    public void testGetHttpParam() {
        ...
        assertEquals(param, AgentParamConstants.OFF_CPU_TIME);
    }
}
