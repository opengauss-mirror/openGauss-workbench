...
/**
 * TestDeadlockAnalysis
 *
 * @author luomeng
 * @since 2023/7/7
 */
@RunWith(MockitoJUnitRunner.class)
public class TestDeadlockAnalysis {
    @Mock
    private DeadlockItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private DeadlockAnalysis deadlockAnalysis;
    ...
    public void testGetSourceDataKeys() {
        List<CollectionItem<?>> result = deadlockAnalysis.getSourceDataKeys();
    ...
    public void testGetShowData() {
        LockDTO data = deadlockAnalysis.getShowData(1);
        assertNull(data);
    }
}
