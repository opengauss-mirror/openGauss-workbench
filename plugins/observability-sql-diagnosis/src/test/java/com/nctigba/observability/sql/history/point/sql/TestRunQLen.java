 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestRunQLen.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.RunQLen;
...
public class TestRunQLen {
    @Mock
    private RunQlenItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private RunQLen pointService;
