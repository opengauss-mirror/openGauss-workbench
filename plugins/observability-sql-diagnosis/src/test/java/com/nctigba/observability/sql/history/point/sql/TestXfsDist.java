 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestXfsDist.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.XfsDist;
...
public class TestXfsDist {
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.XFSDIST;
