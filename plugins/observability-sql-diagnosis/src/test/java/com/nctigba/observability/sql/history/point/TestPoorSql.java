 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/TestPoorSql.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.history.PoorSql;
...
public class TestPoorSql {
    ...
    public void testAnalysisData() {
        AnalysisDTO result = poorSql.analysis(mock(DiagnosisTaskDO.class), dataStoreService);
