 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestBioSnoop.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestBioSnoop {
    @Mock
    private BioSnoopItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private BioSnoop pointService;
