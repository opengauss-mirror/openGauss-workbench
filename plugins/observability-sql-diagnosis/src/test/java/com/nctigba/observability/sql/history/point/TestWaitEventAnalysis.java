 ...
 *  -------------------------------------------------------------------------
 *
 *  TestWaitEventAnalysis.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/TestWaitEventAnalysis.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.history.WaitEventAnalysis;
...
public class TestWaitEventAnalysis {
    ...
    public void testAnalysisData() {
        AnalysisDTO result = waitEventAnalysis.analysis(mock(DiagnosisTaskDO.class), dataStoreService);
