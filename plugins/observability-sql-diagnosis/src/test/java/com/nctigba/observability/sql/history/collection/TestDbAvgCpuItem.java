...
public class TestDbAvgCpuItem {
    ...
    public void testGetPrometheusParam_hasThreshold() {
        ...
        threshold.setThreshold(ThresholdCommon.DB_CPU_USAGE_RATE);
        ...
        assertNotEquals(metric, MetricCommon.DB_AVG_CPU_USAGE_RATE);
    }

    @Test
    public void testGetPrometheusParam_noThreshold() {
        String metric = item.getPrometheusParam(null);
        assertEquals(metric, MetricCommon.DB_AVG_CPU_USAGE_RATE);
    }
}
