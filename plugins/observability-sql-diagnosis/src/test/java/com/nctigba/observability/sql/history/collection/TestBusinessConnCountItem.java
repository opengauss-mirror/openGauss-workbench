 ...
 *  -------------------------------------------------------------------------
 *
 *  TestBusinessConnCountItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/collection/TestBusinessConnCountItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestBusinessConnCountItem {
    ...
    public void testGetPrometheusParam_hasThreshold() {
        ...
        threshold.setThreshold(ThresholdConstants.CONNECTION_NUM);
        ...
        assertNotEquals(metric, MetricConstants.BUSINESS_CONN_COUNT);
    }

    @Test
    public void testGetPrometheusParam_noThreshold() {
        String metric = item.getPrometheusParam(null);
        assertEquals(metric, MetricConstants.BUSINESS_CONN_COUNT);
    }
}
