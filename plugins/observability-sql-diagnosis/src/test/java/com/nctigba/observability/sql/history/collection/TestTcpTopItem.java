 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/collection/TestTcpTopItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestTcpTopItem {
    ...
    public void testGetHttpParam() {
        ...
        assertEquals(param, AgentParamConstants.TCP_TOP);
    }
}
