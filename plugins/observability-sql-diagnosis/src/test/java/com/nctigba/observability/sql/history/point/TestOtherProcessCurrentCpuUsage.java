 ...
 *  -------------------------------------------------------------------------
 *
 *  TestOtherProcessCurrentCpuUsage.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/TestOtherProcessCurrentCpuUsage.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.history.OtherProcessCurrentCpuUsage;
...
/**
 * TestOtherProcessCurrentCpuUsage
 *
 * @author luomeng
 * @since 2023/7/7
 */
...
public class TestOtherProcessCurrentCpuUsage {
    ...
    @InjectMocks
    private OtherProcessCurrentCpuUsage currentCpuUsage;
    ...
    public void before() {
        ...
        diagnosisThreshold.setThreshold(ThresholdConstants.PRO_CPU_USAGE_RATE);
