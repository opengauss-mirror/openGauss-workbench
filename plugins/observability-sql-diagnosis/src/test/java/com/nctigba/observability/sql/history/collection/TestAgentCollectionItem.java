 ...
 *  -------------------------------------------------------------------------
 *
 *  TestAgentCollectionItem.java
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/collection/TestAgentCollectionItem.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.collection.agent.AgentCollectionItem;
...
public class TestAgentCollectionItem {
    ...
    public void testCollectData() {
        when(item.getHttpParam()).thenReturn(AgentParamConstants.TOP);
