 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestFileTop.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.FileTop;
...
public class TestFileTop {
    @Mock
    private FileTopItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private FileTop pointService;
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.FILETOP;
