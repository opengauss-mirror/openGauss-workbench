 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestBioLatency.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class TestBioLatency {
    ...
    public void testGetOption() {
        ...
        List<String> list = bioLatency.getOption();
        assertEquals(actual, list.get(0));
    }

    @Test
    public void testGetSourceDataKeys() {
        List<CollectionItem<?>> result = bioLatency.getSourceDataKeys();
    ...
    public void testAnalysis() {
        ...
        AnalysisDTO result = bioLatency.analysis(mock(DiagnosisTaskDO.class), dataStoreService);
    ...
    public void testGetShowData() {
        Object result = bioLatency.getShowData(1);
        assertNull(result);
    }
}
