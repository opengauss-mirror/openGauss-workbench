 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestCacheStat.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.CacheStat;
...
public class TestCacheStat {
    @Mock
    private CacheStatItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private CacheStat pointService;
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.CACHESTAT;
