 ...
 *
 *  IDENTIFICATION
 *  plugins/observability-sql-diagnosis/src/test/java/com/nctigba/observability/sql/history/point/sql/TestCacheTop.java
 *
 *  -------------------------------------------------------------------------
 */
...
import com.nctigba.observability.sql.service.impl.point.sql.CacheTop;
...
public class TestCacheTop {
    @Mock
    private CacheTopItem item;
    @Mock
    private DataStoreService dataStoreService;
    @InjectMocks
    private CacheTop pointService;
    ...
    public void testAnalysis() {
        ...
        String ioTraceData = TestTxtConstants.CACHETOP;
