export default {
  ...
  datasource: {
    ...
    slowSqlChartMetricTip: '此实例未安装指标采集代理，请先安装实例监控插件，并安装采集代理，对慢SQL指标进行采集；同时保证慢SQL指标的采集开关已打开',
    slowSqlChartAgentTip: '此实例未安装指标采集代理，请先安装实例监控插件，并安装采集代理，对慢SQL指标进行采集；同时保证慢SQL指标的采集开关已打开。',
