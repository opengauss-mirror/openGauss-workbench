export default {
  ...
  datasource: {
    ...
    slowSqlChartErrorTip: 'This instance does not have an indicator collection agent installed. Please install the instance monitoring plugin first and install the collection agent to collect slow SQL indicators; Ensure that the collection switch for slow SQL indicators is turned on at the same time',
    slowSqlChartAgentTip: 'This instance does not have an indicator collection agent installed. Please install the instance monitoring plugin first and install the collection agent to collect slow SQL indicators; Ensure that the collection switch for slow SQL indicators is turned on at the same time',
