export default {
    ...
    dashboard: {
        ...
        table: ['Instance Name', 'Server Status', 'Database Status', 'Connection Info', 'Database Version', 'CPU Usage Of Server', 'Memory Usage Of Server', 'Number Of Database Avtivity Session', 'Number Of Database Block Session'],
    ...
    datasource: {
        ...
        sqlID: 'SQL ID',
        slowSQL: 'Slow SQLs',
        sqlTrackTask: 'SQL Diagnostic Tasks',
        ...
        slowLogTable: ['Start time', 'Finish time', 'Sql text', 'Db name', 'Ip address', 'User', 'Db time', 'Cpu time', 'Data io time', 'Parse time', 'Pl execution time', 'Lock wait time', 'Tuples returned', 'Returned rows'],
        slowStaticTable: ['Sql template', 'Db name', 'Execution num', 'Execution time avg', 'Execution time max', 'Lockwait time avg', 'Lockwait time max', 'Scan row avg', 'Scan row max', 'Return row avg', 'Return row max'],
        ebpfFormRules: ['Please select the instance', 'Please select the database'],
        trackFormRules: ['Please write the task of name', 'Please select the database', 'Please write the sql', 'Please select the Cluster/Instance'],
        trackTable: ['Track name', 'Task type', 'State', 'Start time', 'End time', 'Cost time(s)', 'Create time', 'Cluster ID', 'Instance ID', 'Operate'],
    ...
    spatial: {
        ...
        vacuumDeadNumTable: ['Database Name', 'Schema Name', 'Table Name', 'Table Size', 'Number Of Active Tuples', 'Number Of Death Tuples', 'Death Tuple Ratio'],
        vacuumDeadPro: 'Objects recommended for vacuum - sort according to the proportion of dead tuples',
        vacuumDeadProTable: ['Database Name', 'Schema Name', 'Table Name', 'Table Size', 'Number Of Active Tuples', 'Number Of Death Tuples', 'Death Tuple Ratio'],
    },
    report: {
