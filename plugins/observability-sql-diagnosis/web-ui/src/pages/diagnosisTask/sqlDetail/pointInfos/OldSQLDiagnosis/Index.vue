...
import { optionType, pieColorAll } from '@/pages/datasource/common'
...
watch(res, (originalRes: Res) => {
  chartData.value = [] // clear data
  console.log('DEBUG:originalRes', originalRes)
  let res = originalRes.data.pointData[0]
  res.type = res.frameType
