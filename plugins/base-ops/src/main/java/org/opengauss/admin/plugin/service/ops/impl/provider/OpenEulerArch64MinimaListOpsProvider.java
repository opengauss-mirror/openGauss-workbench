 ...
 * -------------------------------------------------------------------------
 *
 * OpenEulerArch64MinimaListOpsProvider.java
 *
 * IDENTIFICATION
 * base-ops/src/main/java/org/opengauss/admin/plugin/service/ops/impl/provider/OpenEulerArch64MinimaListOpsProvider.java
 *
 * -------------------------------------------------------------------------
 */
...
@Slf4j
@Service
public class OpenEulerArch64MinimaListOpsProvider extends AbstractOpsProvider {
    ...
    public String dependencyCommand() {
        return SshCommandConstants.INSTALL_DEPENDENCY_OPENEULER_ARCH64;
    }
