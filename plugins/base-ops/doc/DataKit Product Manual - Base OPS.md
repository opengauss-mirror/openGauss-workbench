...
![](_resources/upgrade-config-3.png)
...
![](_resources/upgrade-check-2.png)
...
![](_resources/create_device_manager_interface.png)
...
当安装任务通过环境检查后，对任务进行下一步的确认。确认后任务自动从草稿箱流转到任务列表中。进入待执行状态
