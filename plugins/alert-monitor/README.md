...
3、在target目录下找到生成的alert-monitor-7.0.0-RC2-repackage.jar，安装到一体化平台
...
<center>图5-6 实例告警配置列表</center>

![13](doc/13-1.png)

<center>图5-7 非实例告警配置列表</center>
...
<center>图5-23 编辑通知模板（一）</center>

![24](doc/24-1.png)

<center>图5-24 编辑通知模板（二）</center>
...
<center>图5-28 编辑通知方式（二）</center>

![27](doc/27-3.png)

<center>图5-29 编辑通知方式（三）</center>
...
1、点击6.0.1 告警屏蔽页面中的【新建屏蔽规则】按钮或者点击告警屏蔽列表中的【编辑】按钮，进入告警屏蔽规则修改页面。
