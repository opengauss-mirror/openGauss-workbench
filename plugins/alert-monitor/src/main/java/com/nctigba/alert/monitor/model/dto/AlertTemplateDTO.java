 ...
 *  -------------------------------------------------------------------------
 *
 *  AlertTemplateDTO.java
 *
 *  IDENTIFICATION
 *  plugins/alert-monitor/src/main/java/com/nctigba/alert/monitor/model/dto/AlertTemplateDTO.java
 *
 *  -------------------------------------------------------------------------
 */
 ...
 *
 * @author wuyuebin
 * @since 2023/5/15 18:48
 */
@Data
@Accessors(chain = true)
public class AlertTemplateDTO extends AlertTemplateDO {
