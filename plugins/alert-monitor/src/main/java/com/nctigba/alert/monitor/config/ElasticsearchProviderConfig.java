 ...
 *  -------------------------------------------------------------------------
 *
 *  ElasticsearchProviderConfig.java
 *
 *  IDENTIFICATION
 *  plugins/alert-monitor/src/main/java/com/nctigba/alert/monitor/config/ElasticsearchProviderConfig.java
 *
 *  -------------------------------------------------------------------------
 */
...
public class ElasticsearchProviderConfig {
    ...
    public ElasticsearchClient client() {
        NctigbaEnvDO env = envMapper.selectOne(
            Wrappers.<NctigbaEnvDO>lambdaQuery().eq(NctigbaEnvDO::getType, NctigbaEnvDO.Type.ELASTICSEARCH));
