...
@Slf4j
@Service
@Extract(bus = "webds-extension")
public class WebdsExtensionInfoServiceImpl implements PluginExtensionInfoExtract {
    @Override
    public PluginExtensionInfoDto getPluginExtensionInfo() {
        ...
        dto.setPluginName("webds-plugin");
