...
<table>
    ...
    <tr>
        <td>连接信息</td>
        <td>新建连接、编辑连接、查看连接属性、删除连接</td>
    </tr>
    <tr>
        <td rowspan="4">表</td>
        <td>查看表：查看DDL、查看一般、查看列、查看约束、查看索引、查看数据、查看分区</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>管理表数据：操作表数据、导出表数据、导出表DDL和数据、导出表数据、导入表数据</td>
    </tr>
    <tr>
        <td>序列</td>
    ...
    <tr>
        <td>使用SQL查询：使用SQL单条查询、执行多条函数/过程或查询</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>使用函数/过程：执行函数/过程、删除函数/过程、导出函数/过程DDL</td>
    </tr>
    <tr>
...
**步骤 1：** 若不存在连接，默认弹出 **"新建连接"** 对话框；若已存在连接，可在工具栏中单击<img src="photo/5-2.1.png" style="zoom:50%;" />，弹出 **"新建连接"** 对话框。 
...
​			支持查看表属性，查看内容包含 DDL、一般、列、约束、索引、数据，若所选表为分区表，查看内容还将包含分区属性。

##### 5.3.1.1 查看 DDL

​             执行以下步骤查看 DDL：

**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**DDL**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**一般**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**列**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**约束**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**索引**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，将显示所选表对应的属性与数据，选中 "**数据**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击普通表列表，若所选表为分区表，将显示分区属性，选中 "**分区**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**普通表**" ，选择 "**创建表**" ，弹出 "**创建表**" 对话框。 
...
| --------- | ---- | ---------------------------------------------------- |
| 列名称    | 是   | 用于定义列名称                                       |
| 数据类型  | 是   | 用于配置数据库常用数据类型，默认为第一个数据类型     |
...
<table>
    ...
    <tr>
        <td>列名称</td>
        <td>是</td>
        <td>该配置项用于选择定义约束的列名称</td>
    </tr>
    <tr>
        <td>约束类型</td>
        <td>是</td>
        <td>该配置项用于选择定义约束的类型；配置项：CHECK、UNIQUE、PRIMARY KEY、FOREIGN KEY、<br/>PARTIAL CLUSTER KEY，以上数据由前端固定配置，其中FOREIGN KEY选项下一级分别需要配置命名空间、<br/>表、列，对应数据由后端返回；如果选择多个列，配置项中的FOREIGN KEY选项置灰不可选，一个外键只能<br/>设置一个列</td>
    </tr>
    <tr>
        <td>表达式</td>
        <td>否</td>
        <td>该配置项用于定义约束的表达式</td>
    </tr>
    <tr>
        <td>能否延迟</td>
        <td>否</td>
        <td>该配置项用于定义约束延迟检查功能，设置延迟类型为IMMEDIATE</td>
    </tr>
    <tr>
        <td>描述</td>
        <td>否</td>
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**查询相关序列**" ，进入显示相关序列页面。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**重建索引**" ，弹出确认对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**清理表**" ，弹出确认对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**截断表**" ，弹出确认对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**设置表模式**" ，弹出设置表模式对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**设置表空间**" ，弹出设置表空间对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**设置表描述**" ，弹出设置表描述对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**重命名表**" ，弹出重命名表对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**删除表**" ，弹出确认对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**分析表**" ，弹出确认对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**导出 DDL**" 。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**导出 DDL 和数据**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**导出表数据**" ，弹出 "**导出表数据**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的表名称，选择 "**导入表数据**" 或者在表数据操作工具栏点击<img src="photo/icon_import.png" style="zoom:55%;" />，弹出 "**导出表数据**" 对话框。 
...
<img src="photo/5-3-4-5.png" style="zoom:50%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**序列**"，选择 "**创建序列**"，弹出 "**创建序列**" 对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的序列列表，选择 "**删除序列**"，弹出 "**删除序列**" 确认框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的序列名称，选择 "**导出 DDL**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的序列名称，选择 "**导出 DDL 和数据**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**视图**"，选择 "**创建视图**"，弹出 "**创建视图**" 对话框。
...
| 所需对象模式 | 是   | 用于定于所属对象模式，默认为当前模式，置灰不可选       |
| 代码         | 是   | 用于编写sql语句，默认为空                              |
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的视图列表，选择 "**删除视图**"，弹出 "**删除视图**" 确认框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击视图列表，所选视图对应的4大维度内容，默认显示DDL。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击视图列表，所选视图对应的4大维度内容，选中 "**一般**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击视图列表，所选视图对应的4大维度内容，选中 "**列**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击视图列表，所选视图对应的4大维度内容，选中 "**数据**"。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的视图名称，选择 "**编辑视图**"。 
...
<img src="photo/5-5-4.png" style="zoom:50%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的视图名称，选择 "**导出 DDL**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**同义词**"，选择 "**创建同义词**"，弹出 "**创建同义词**" 对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的同义词列表，选择 "**删除同义词**"，弹出 "**删除同义词**" 确认框。
...
**步骤** **1**： 在页签栏的目标终端选择框中，选择目标终端，选择<img src="photo/5-7-1.0.png" style="zoom: 50%;" />新建终端，即可显示新的 "SQL终端" 页签。

​                **说明：**目标终端的下拉选项值为所有连接中的数据库，默认为最近打开连接的数据库。

​                           "SQL终端" 命名规则为：终端图标+数据库名+@+连接名称+(自增数)，如<img src="photo/5-7-1.1.png" style="zoom: 50%;" />。
...
| 序号     | 执行历史记录的序号                                           |
| 开始时间 | SQL查询的开始时间                                            |
| 状态     | SQL查询的执行状态：<img src="photo/icon_success.jpg" style="zoom:80%;" /> <img src="photo/icon_fail.jpg" style="zoom:80%;" /> |
| SQL语句  | SQL查询的执行语句                                            |
| 执行时间 | SQL查询的执行耗时，单位：ms                                  |
| 操作     | <img src="photo/icon_preview.jpg" style="zoom:80%;" />预览SQL语句弹窗、<img src="photo/icon_lock.jpg" style="zoom:80%;" />锁定/<img src="photo/icon_unlock.jpg" style="zoom:80%;" />取消锁定、<img src="photo/icon_delete.jpg" style="zoom:80%;" />删除 |

**步骤** **2**： 选择 <img src="photo/icon_preview.jpg" style="zoom:80%;" />，打开 SQL 语句预览弹窗，用于查看当前执行操作的 SQL 语句。
...
**步骤** **3**： 选择 <img src="photo/icon_lock.jpg" style="zoom:80%;" /> / <img src="photo/icon_unlock.jpg" style="zoom:80%;" />，锁定 / 解锁当前执行 SQL 操作记录，用于置顶 / 取消置顶当前执行操作的 SQL 语句。

​                 **说明：**<img src="photo/icon_lock.jpg" style="zoom:80%;" />锁定：单击按钮可将当行记录锁定，锁定后置顶当行记录并置灰，序号前新增<img src="photo/icon_disablelock.jpg" style="zoom:80%;" />图标，不支持删除操作。

​                            <img src="photo/icon_unlock.jpg" style="zoom:80%;" />取消锁定：单击按钮可将当行记录取消锁定，取消锁定后取消当行记录置顶状态，取消<img src="photo/icon_disablelock.jpg" style="zoom:80%;" />图标，支持删除操作。

​                            同一平台用户所操作的执行历史记录最多锁定50条，超出将显示提示语句。

**步骤** **4**： 选择 <img src="photo/icon_delete.jpg" style="zoom:80%;" />，单击按钮将弹出确认删除弹窗，确认后可将当行记录删除，该删除操作不可逆。
...
**步骤 1**：在 "**数据库列表**" 窗格中，右键单击数据库中的 "**函数/过程**"，按照要求选择“**创建函数**”、“**创建过程**”、“**创建** **SQL** **函数**”、"**匿名块**"。
...
**步骤** **1**：在 "**数据库列表**" 窗格中，右键单击数据库中的函数/过程对象，选择 “**删除函数/过程**” 。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的函数/过程名称，选择 "**导出 DDL**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的 "**数据库**" ，选择 "**创建数据库**" ，弹出 "**创建数据库**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**打开连接**"，操作成功后将更新数据库连接状态。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**断开连接**"，弹出 "**断开连接**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**编辑数据库属性**"，弹出 "**编辑数据库属性**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**删除数据库**"，弹出 "**删除数据库**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**查看数据库属性**"，对话框将显示所选数据库的属性。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**打开新终端**"，新终端将连接目标数据库。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**设置断连时间**"，弹出 "**设置数据库自动断连时间**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的数据库名称，选择 "**创建模式**" ，弹出 "**创建模式**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的模式名称，选择 "**编辑模式**"，弹出 "**编辑模式**" 对话框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的模式名称，选择 "**删除模式**"，弹出 "**删除模式**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的模式名称，选择 "**导出 DDL**"。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的模式名称，选择 "**导出 DDL 和数据**"。    
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的 "**用户/角色**" ，选择 "**创建用户/角色**" ，跳转至 "**创建用户/角色**" 页面。 
...
<img src="photo/5-11-1.1.png" style="zoom:67%;" />
...
<img src="photo/5-11-1.2.png" style="zoom:67%;" />
...
<img src="photo/5-11-1.3.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击用户/角色列表，跳转至用户/角色查看与编辑页面。 
...
<img src="photo/5-11-2.1.png" style="zoom:67%;" />
...
<img src="photo/5-11-2.2.png" style="zoom:67%;" />



**查看 DDL**

<img src="photo/5-11-2.3.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的用户/角色名称，选择 "**修改密码**"，弹出 "**修改用户/角色密码**" 对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的用户/角色名称，选择 "**删除用户/角色**"，弹出 "**删除用户/角色**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**外表**" ，选择 "**创建外表**" ，跳转至 "**创建外表**" 页面。 
...
<img src="photo/5-12-1.1.png" style="zoom:67%;" />
...
<img src="photo/5-12-1.4.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，展开数据库中的外表列表，单击外表列表，跳转至外表查看与编辑页面。 
...
<img src="photo/5-12-2.1.png" style="zoom:67%;" />



**查看外部**

<img src="photo/5-12-2.2.png" style="zoom:67%;" />
...
<img src="photo/5-12-2.3.png" style="zoom:67%;" />



**修改数据**

​        与普通表操作表数据同，详情请参见 **5.3.4.1 操作表数据**
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的外表名称，选择 "**删除表**"，弹出 "**删除表**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的 "**表空间**" ，选择 "**创建表空间**" ，跳转至 "**创建表空间**" 页面。 
...
<img src="photo/5-13-1.1.png" style="zoom:67%;" />
...
<img src="photo/5-13-1.2.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，单击表空间列表，跳转至表空间查看与编辑页面。 
...
<img src="photo/5-13-2.1.png" style="zoom:67%;" />



**查看 DDL**

<img src="photo/5-13-2.2.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击连接名称下的表空间名称，选择 "**删除表空间**"，弹出 "**删除表空间**" 确认框。 
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的 "**触发器**" ，选择 "**创建触发器**" ，跳转至 "**创建触发器**" 页面。 
...
<img src="photo/5-14-1.1.png" style="zoom:67%;" />
...
<img src="photo/5-14-1.2.png" style="zoom:67%;" />
...
**步骤 1：** 在 "**数据库列表**" 窗格中，展开数据库中的触发器列表，单击触发器名称，跳转至触发器查看与编辑页面。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的触发器名称，选择 "**重命名触发器**" ，弹出重命名触发器对话框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的触发器名称，选择 "**启用触发器**" 或 "**禁用触发器**" ，弹出修改触发器状态确认框。
...
**步骤 1：** 在 "**数据库列表**" 窗格中，右键单击数据库中的触发器名称，选择 "**删除触发器**"，弹出 "**删除触发器**" 确认框。 
...
**步骤 1：** 在页签上方的工具栏中，选择<img src="photo/icon_task.png" style="zoom: 50%;" />定时任务，跳转至定时任务列表页面。
...
8、无法创建外表数据源类型为 Oracle、MySQL 的外部表。
