...
export const constantRoutes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'createDebug',
        meta: { title: '', icon: 'file-script', keepAlive: true },
      },
      {
        path: '/debug/:id',
        component: () => import('@/views/debug/index.vue'),
      ...
      {
        path: '/createView/:id(\\d+)',
        component: () => import('@/views/view/CreateView.vue'),
        name: 'createView',
        meta: { title: '', icon: 'view', keepAlive: true },
      },
      {
        path: '/view/:id',
      ...
      {
        path: '/createSynonym/:id(\\d+)',
        component: () => import('@/views/synonym/CreateSynonym.vue'),
        name: 'createSynonym',
        meta: { title: '', icon: 'synonym', keepAlive: true },
      },
      {
        path: '/synonym/:id',
      ...
      {
        path: '/createSequence/:id(\\d+)',
        component: () => import('@/views/sequence/CreateSequence.vue'),
        name: 'createSequence',
        meta: { title: '', icon: 'sequence', keepAlive: true },
      },
      {
        path: '/sequence/:id',
