    ...
    if (nameS == heroes[i].功能大类) {
      if (heroes[i].功能子类 != '') {
        ...
        if (tempClassBool) {
          ...
          tempSuggestion =
            "<div><div class = 'font_color' style = 'margin: 10px 0px 10px 20px;'>" +
            heroes[i].功能子类 +
            '</div>' +
            "<table class = 'operShowTable'><thead class='tablehead'><tr><th class = 'title_task'>任务</th><th class = 'title_cmd'>命令</th><th>说明</th></tr></thead><tbody id = " +
            heroes[i].功能子类 +
            '></table></table></div>';
        ...
        tempSuggestion =
          "<tr><td class = 'font_color'><a class = 'font_color' href='enter_list_next.html?param1=" +
          record +
          '&param2=' +
          heroes[i].操作命令 +
          "'>" +
          heroes[i].任务名称 +
          "</a></td><td style = 'font-size: 11px;'><a class = 'font_color' id=" +
          commandId +
          " href='enter_list_next.html?param1=" +
          record +
          '&param2=' +
          heroes[i].操作命令 +
          "'>" +
      ...
      if (heroes[i].子场景 != '') {
        if (tempClass != heroes[i].子场景) {
          tempSuggestion =
            ...
            heroes[i].子场景 +
            '<div>' +
            "<thead class='tablehead'><tr><th>任务</th><th>命令</th><th>说明</th></tr></thead>";
          $('#haveSubclass').append(tempSuggestion);
        }
        getSQLHtmlForDescription(allcmds, heroes[i].操作命令);
        tempSuggestion =
