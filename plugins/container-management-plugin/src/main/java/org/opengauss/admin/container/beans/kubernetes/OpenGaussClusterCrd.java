 ...
 */
@Data
public class OpenGaussClusterCrd implements Serializable {
    private static final long serialVersionUID = 1L;

    private String kind;
    private String apiVersion;
    private V1ObjectMeta metadata;
    private OpenGaussClusterSpec spec;
    private OpenGaussClusterStatus status;
}
