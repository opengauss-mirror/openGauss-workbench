            ...
            <div class="upload-box">
                <div class="upload-add">
                    ...
                    <div class="upload-tip">
                      {{$t('step2.compoents.uploadPortalDlg.dragMsg')}}
                        <div style="margin-top: 16px">
                            <el-button type="primary" size="small">{{$t('step2.compoents.uploadPortalDlg.clickToUpload')}}</el-button>
                        </div>
                    </div>
