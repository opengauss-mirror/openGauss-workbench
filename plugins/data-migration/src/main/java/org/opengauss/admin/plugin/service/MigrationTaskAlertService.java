...
public interface MigrationTaskAlertService extends IService<MigrationTaskAlert> {
     ...
     * @return page info
     */
    IPage<MigrationTaskAlert> selectPage(IPage<MigrationTaskAlert> page, int taskId, int migrationPhase);
    ...
    /**
     * count alert numbers of each migration phase
     *
     * @param taskId task id
     * @return alert numbers of each migration phase
     */
    AjaxResult countAlertNumber(int taskId);
