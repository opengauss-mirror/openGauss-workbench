 ...
 * -------------------------------------------------------------------------
 *
 * MigrationTaskInitGlobalParamServiceImpl.java
 *
 * IDENTIFICATION
 * data-migration/src/main/java/org/opengauss/admin/plugin/service/impl/MigrationTaskInitGlobalParamServiceImpl.java
 *
 * -------------------------------------------------------------------------
 */
