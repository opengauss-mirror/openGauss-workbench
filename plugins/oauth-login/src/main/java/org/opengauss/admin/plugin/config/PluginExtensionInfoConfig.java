 ...
 *
 * IDENTIFICATION
 * oauth-login/src/main/java/org/opengauss/admin/plugin/config/PluginExtensionInfoConfig.java
 *
 * -------------------------------------------------------------------------
 */
...
public class PluginExtensionInfoConfig implements PluginExtensionInfo {
    /**
     * register plugin extension information
     *
     * @return Map
     */
    @Override
    public Map<String, Object> extensionInfo() {
        ...
        map.put("descriptionEn", "Oauth Login Plugin");
        return map;
    }
}
